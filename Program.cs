        ...
        private static void ShowHistory(string password, string walletName)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                foreach (var entry in transactions.Operations)
                {
                    ...
                    {
                        Money amount = (Money)coin.Amount;
                        WriteLine($"Transaction ID: {coin.Output}; Received coins: {amount.ToDecimal(MoneyUnit.BTC)}");
                    }
                }
            }
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                foreach (var entry in transactions.Operations)
                {
                    ...
                    {
                        Money amount = (Money)coin.Amount;
                        WriteLine($"Transaction ID: {coin.Output}; Spent coins: {amount.ToDecimal(MoneyUnit.BTC)}");
                    }
                }
            }
